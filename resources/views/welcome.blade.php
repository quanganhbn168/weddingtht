...
<body class="bg-white text-gray-900 antialiased">
    ...
    <section class="min-h-screen flex items-center relative overflow-hidden pt-24 pb-16 bg-gradient-to-br from-amber-50 via-white to-rose-50">
        <div class="absolute top-20 right-10 w-72 h-72 bg-amber-100 rounded-full blur-3xl opacity-50"></div>
        <div class="absolute bottom-20 left-10 w-96 h-96 bg-rose-100 rounded-full blur-3xl opacity-50"></div>
        
        <div class="max-w-6xl mx-auto px-6 relative z-10 w-full">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <span class="inline-block px-4 py-2 rounded-full bg-amber-100 text-amber-800 font-semibold text-sm mb-6" data-aos="fade-up">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight mb-6" data-aos="fade-up" data-aos-delay="100">
                        Thiệp Cưới &<br>
                        <span class="text-gold">Danh Thiếp Số</span><br>
                        Cao Cấp
                    </h1>
                    
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed max-w-lg" data-aos="fade-up" data-aos-delay="200">
                        THT Media mang đến giải pháp thiết kế thiệp cưới online và danh thiếp số độc đáo, sang trọng. Mỗi thiết kế là một tác phẩm nghệ thuật.
                    </p>
                    
                    <div class="flex flex-wrap gap-4 mb-10" data-aos="fade-up" data-aos-delay="300">
                        <a href="#contact" class="inline-flex items-center gap-2 px-8 py-4 rounded-full gradient-gold text-white font-bold hover:opacity-90 transition shadow-xl shadow-amber-200">
                            <span>Liên hệ tư vấn</span>
                            <i class="fas fa-arrow-right"></i>
                        </a>
                        <a href="#portfolio" class="inline-flex items-center px-8 py-4 rounded-full bg-white border-2 border-gray-200 font-bold hover:border-gray-400 transition">
                    ...
                    <div class="flex gap-8 pt-8 border-t border-gray-200" data-aos="fade-up" data-aos-delay="400">
                        <div>
                            ...
                            <div class="text-sm text-gray-500 mt-1">Thiệp đã thiết kế</div>
                        </div>
                        <div>
                        ...
                        <div>
                            <div class="text-3xl font-bold text-gold">24h</div>
                            <div class="text-sm text-gray-500 mt-1">Hoàn thành nhanh</div>
                        </div>
                    </div>
                </div>
                
                <div class="relative" data-aos="fade-left" data-aos-duration="1000">
                    <div class="absolute inset-0 gradient-gold rounded-3xl blur-3xl opacity-20"></div>
    ...
    <footer class="py-8 bg-slate-950 border-t border-white/5">
        <div class="max-w-6xl mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <a href="https://thtmedia.com.vn" target="_blank" class="flex items-center">
