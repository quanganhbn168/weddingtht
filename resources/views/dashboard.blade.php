<x-dashboard-layout>
    <x-slot:header>Tổng quan</x-slot:header>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <a href="{{ route('dashboard.weddings.create') }}" class="bg-white hover:bg-gray-50 overflow-hidden shadow-sm rounded-xl p-6 flex items-center gap-4 transition border-2 border-transparent hover:border-pink-400">
        ...
        <a href="{{ route('dashboard.cards.create') }}" class="bg-white hover:bg-gray-50 overflow-hidden shadow-sm rounded-xl p-6 flex items-center gap-4 transition border-2 border-transparent hover:border-blue-400">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-xl mb-6">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('dashboard.weddings.index') }}" class="text-pink-600 hover:text-pink-800 text-sm">Xem tất cả →</a>
        </div>
        <div class="divide-y divide-gray-200">
            ...
            <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                ...
                <div class="flex items-center gap-2">
                    @if($wedding->tier === 'pro')
                        <span class="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800">Pro</span>
                    @endif
                    ...
                    <a href="{{ route('dashboard.weddings.edit', $wedding) }}" class="text-pink-600 hover:text-pink-800 text-sm">Sửa</a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-xl">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('dashboard.cards.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">Xem tất cả →</a>
        </div>
        <div class="divide-y divide-gray-200">
            ...
            <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('dashboard.cards.edit', $card) }}" class="text-blue-600 hover:text-blue-800 text-sm">Sửa</a>
                </div>
            </div>
            @endforeach
        </div>
