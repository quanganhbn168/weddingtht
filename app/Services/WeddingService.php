...
class WeddingService
{
    ...
    public static function getValidationRules(Wedding $wedding): array
    {
        return [
            ...
            'groom_qr_bank_id' => 'nullable|string|max:20',
            'groom_qr_account_number' => 'nullable|string|regex:/^[0-9]{6,19}$/',
            'groom_qr_account_name' => 'nullable|string|max:255',
            'groom_qr_amount' => 'nullable|integer|min:0',
            'groom_qr_add_info' => 'nullable|string|max:100',
            'bride_qr_bank_id' => 'nullable|string|max:20',
            'bride_qr_account_number' => 'nullable|string|regex:/^[0-9]{6,19}$/',
            'bride_qr_account_name' => 'nullable|string|max:255',
            'bride_qr_amount' => 'nullable|integer|min:0',
            'bride_qr_add_info' => 'nullable|string|max:100',
